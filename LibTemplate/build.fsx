...
module ProjectInfo = 
    ...
    let project = "Library Template"

    let summary = "A description about the library"

    let configuration = "Release"

    // Git configuration (used for publishing documentation in gh-pages branch)
    // The profile where the project is posted
    let gitOwner = "OnofreTZK"
    let gitName = "FSharpLibraryTemplate"

    let gitHome = sprintf "%s/%s" "https://github.com" gitOwner

    let projectRepo = sprintf "%s/%s/%s" "https://github.com" gitOwner gitName

    let website = "/FSharpLibraryTemplate"
